...
$options = array(
	'general' => array(
		...
		'options' => array(
			'lsi_style_css' => array(
				'label' => __('Lakshmi Style', 'lakshmi-lite'),
				'type' => 'short-select',
				'value' => 'default',
				'choices' => array(
					'default' => __( 'Default', 'lakshmi-lite'),
					'blogger' => __( 'Blogger', 'lakshmi-lite'),
					'hinduist' => __( 'Hinduist', 'lakshmi-lite'),
					'africa' => __( 'Africa', 'lakshmi-lite'),
					'clean' => __( 'Clean', 'lakshmi-lite'),
				),
			),
